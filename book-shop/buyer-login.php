		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Buyer Login</li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" class="register-form" method="post" action="buyer-action.php">
			<h2>Buyer Login</h2>
			<hr class="colorgraph">
			...
			<div class="col-xs-12 col-md-6">Don't have an account? <a href="buyer-registration.php">Register</a></div>
			</div>
		</form>
	</div>
</div>
