...
if(isset($_REQUEST['btnSubmit'])) 
	{
		...
		$query = "insert into seller (sname,mobile,email,address,username,password,stype) values ('$sname','$mobile','$email','$address','$username','$password','$stype')";
		if(mysql_query($query))
		{
		echo '<script language="javascript">';
		echo 'alert("Seller Registered Successfully!")';
		echo '</script>';
		} 
		else 
		{
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" class="register-form" method="post">
			...
			<div class="form-group">
				<input type="text" name="sname" class="form-control input-lg" placeholder="Name" required>
			</div>
            <div class="form-group">
